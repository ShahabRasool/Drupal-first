...
class ViewModeSwitchItemTest extends UnitTestCase {
   ...
   */
  public static function dataProviderSettingsToConfigData(): array {
    $expected = [
      'bar' => 'bar',
   ...
   *   The test data.
   */
  public static function dataProviderGetSettableOptions(): array {
    return [
      'all' => [
        FALSE,
        [
   ...
   *   The test data.
   */
  public static function dataProviderGetSettableValues(): array {
    return [
      'all' => [
        FALSE,
        [
   ...
   *   The test data.
   */
  public static function dataProviderGetViewMode(): array {
    return [
      'bar' => [
        'bar',
        'bar',
   ...
   *   The test data.
   */
  public static function dataProviderIsApplicable(): array {
    return [
      'default-to-bar' => [
        'default',
        'bar',
   ...
   *   The test data.
   */
  public static function dataProviderIsResponsible(): array {
    return [
      'default' => [
        'default',
        TRUE,
  ...
  public function testSchema(): void {
    ...
    $this->assertEquals([
      'type' => 'varchar_ascii',
      'length' => ViewModeSwitchItemInterface::VALUE_MAX_LENGTH,
