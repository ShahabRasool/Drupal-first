...
class ViewModeSwitchItemListTest extends UnitTestCase {
   ...
   *   The test data.
   */
  public static function dataProviderGetAllowedViewModes(): array {
    return [
      'returns-view-modes' => [
        [
          'foo' => 'foo',
   ...
   *   The test data.
   */
  public static function dataProviderGetRepresentativeItem(): array {
    return [
      [TRUE],
      [FALSE],
    ];
   ...
   *   The test data.
   */
  public static function dataProviderGetOriginViewModes(): array {
    return [
      'returns-view-modes' => [
        [
          'foo' => 'foo',
