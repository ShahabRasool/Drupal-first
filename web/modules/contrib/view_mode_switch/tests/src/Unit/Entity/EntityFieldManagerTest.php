...
class EntityFieldManagerTest extends UnitTestCase {
   ...
   *   The test data.
   */
  public static function dataProviderGetApplicableField(): array {
    return [
   ...
   */
  public static function dataProviderGetFieldCandidateNames(): array {
    return [
      [
        'entity_type_foo',
        'bundle_foo_foo',
   ...
   *   The test data.
   */
  public static function dataProviderGetFieldStorageDefinitionsUsingOriginViewMode(): array {
   ...
   *   The test data.
   */
  public static function dataProviderGetResponsibleFields(): array {
    return [
   ...
   *   The test data.
   */
  public static function dataProviderRemoveOriginViewModeFromFieldStorageConfigs(): array {
    return [
