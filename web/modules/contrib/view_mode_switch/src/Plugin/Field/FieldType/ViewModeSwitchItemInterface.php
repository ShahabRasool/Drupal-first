...
interface ViewModeSwitchItemInterface extends FieldItemInterface, OptionsProviderInterface {
  ...
  /**
   * Maximum length of the 'value' property.
   *
   * This length corresponds to the length limit of the 'machine_name' form
   * element that is used for machine-readable names of view modes.
   */
